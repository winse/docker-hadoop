...
kube::multinode::start_etcd() {
  ...
  # Reuse images
  docker save gcr.io/google_containers/etcd-${ARCH}:${ETCD_VERSION} | docker ${BOOTSTRAP_DOCKER_PARAM} load
...
kube::multinode::start_flannel() {
  ...
  docker save quay.io/coreos/flannel:${FLANNEL_VERSION}-${ARCH} | docker ${BOOTSTRAP_DOCKER_PARAM} load 
